...
public class PhantomReferenceDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Reference<MyObject> phanRef = new PhantomReference<MyObject>(object,queue);
        System.out.println("创建的虚引用对象为 ：" + phanRef);
    ...
    public static class CheckRefQueue implements Runnable{
        ...
        public void run() {
            try {
                ...
                System.out.println("删除的虚引用为： " + obj + "获取的虚引用对象：" + obj.get());
                System.exit(0);
